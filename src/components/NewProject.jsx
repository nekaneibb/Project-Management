...
export default function NewProject({ createProject, cancelCreateProject }) {
  ...
  return (
    <div className="w-[35rem] mt-16 flex flex-col">
      ...
      <p className="text-stone-600 mb-8 mt-6 text-center">The title must be completed</p>
       </Modal>
      <menu className="flex items-center justify-end gap-4 my-4">
        <button className=" text-stone-800 hover:text-stone-500 font-medium py-2 px-4 " onClick={cancelCreateProject}>
          Cancel
        </button>
